 ...
 */
final class Version20210408013625 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game_score (game_id INT NOT NULL, score_id INT NOT NULL, INDEX IDX_AA4EDEE48FD905 (game_id), INDEX IDX_AA4EDE12EB0A51 (score_id), PRIMARY KEY(game_id, score_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE score_game (score_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_933B0FA12EB0A51 (score_id), INDEX IDX_933B0FAE48FD905 (game_id), PRIMARY KEY(score_id, game_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
